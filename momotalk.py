...
def determine_conversation(window) :
    pass
...
def momotalk_routine(window) :
    ...
    window["row1"].update(f"Momotalk Cleared : {count}",text_color="#509296",font=("Helvetica", 16, "bold"),background_color="#f0f0f0")
